...
export default function Boats() {
  ...
  const userAds = useUserAds(['Boats & Jet Skis']);
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="mb-5">
          <div className="flex items-center gap-8 mb-3">
            <h1 className="text-2xl font-bold text-foreground whitespace-nowrap">Boats & Jet Skis</h1>
          </div>
        </div>
        ...
        <div className="hidden lg:flex items-center gap-8 mb-5">
          <div className="relative flex-1 max-w-[35%]">
            ...
            <input
              ...
              placeholder="Search Boats & Jet Skis"
        ...
        <div className="flex gap-6">
          ...
          <div className="flex-1 min-w-0 min-h-[calc(100vh+4rem)]">
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-muted-foreground"><span className="font-semibold text-foreground">{allFiltered.length.toLocaleString()}</span> ads for Boats & Jet Skis in Ireland</p>
            ...
            <div className="flex flex-col gap-4">
              ...
              {filtered.length === 0 && <div className="text-center py-16 text-muted-foreground"><p className="text-lg font-medium">No boats found</p><p className="text-sm mt-1">Try adjusting your search</p></div>}
            </div>
