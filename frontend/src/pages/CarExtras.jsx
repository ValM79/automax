...
export default function CarExtras() {
  ...
  const userAds = useUserAds(['Car Extras', 'Motorbike Extras']);
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        ...
        <div className="mb-5">
          <div className="flex items-center gap-8 mb-3">
            <h1 className="text-2xl font-bold text-foreground whitespace-nowrap">Car Extras</h1>
          </div>
        </div>
        ...
        <MobileCategoryFilters search={search} onSearchChange={(e) => setSearch(e.target.value)} placeholder="Search Car Extras">
          ...
          <div className="flex-1 min-w-0 min-h-[calc(100vh+4rem)]">
            ...
            <div className="flex items-center justify-between mb-4">
              <p className="text-sm text-muted-foreground">
                <span className="font-semibold text-foreground">{allFiltered.length.toLocaleString()}</span> ads for Car Extras in Ireland
              </p>
            ...
            <div className="flex flex-col gap-4">
              ...
              <ListingCard
                ...
                onToggleSave={() => toggleFavorite(item.isUserAd ? item : { ...item, timeAgo: item.hoursAgo })}
                viewMode="list" />
